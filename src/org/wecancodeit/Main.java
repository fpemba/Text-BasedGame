    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            while (enemyHealth > 0) {
                ...
                System.out.println("\t2. Drink health potioin");
                ...
                if (input.equals("1")) {
                    ...
                    if (numHealthPotions > 0) {
                        ...
                        System.out.println("\t> You have no health potions left! Defeat enemies " +
            ...
            if (rand.nextInt(100) < healthPotionDropChance) {
                numHealthPotions++;
                System.out.println(" # The " + enemy + " droppe a health potion! # ");
